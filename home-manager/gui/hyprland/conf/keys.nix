...
in
{
  ...
  wayland.windowManager.hyprland = {
    settings.bind = [
      ...
      (execBind "SUPER + ALT + period" "walker -m menus:obs-reaction -p '📹 OBS Studio Emoji Reaction'")
      (execBind "SUPER + R" "walker -p 'Search'")
      (execBind "SUPER + period" "walker -m menus:emoji -p '😀 Emoji selector'")
      (execBind "SUPER + ALT + c" "walker -m clipboard -p '📋 Clipboard'")
