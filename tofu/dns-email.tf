variable "domains" {
  ...
  validation {
    condition     = alltrue([for domain in var.domains : contains(["custom", "google", "cloudflare", "stalwart"], domain.mx_provider)])
    error_message = "The mx_provider must be one of 'custom', 'google', 'cloudflare', or 'stalwart'."
  }
