{ pkgs, ... }:
{
  systemd.services.rsync-fonts-to-rofl-03 = {
    description = "Rsync font files to github-actions@rofl-03.brkn.lol";
  ...
  systemd.timers.rsync-fonts-to-rofl-03 = {
    description = "Timer for SCP to github-actions@rofl-03.brkn.lol";
